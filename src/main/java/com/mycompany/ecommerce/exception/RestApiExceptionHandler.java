...
public class RestApiExceptionHandler {
	...
	protected ResponseEntity<Object> handleException(Exception ex, HttpHeaders headers, HttpStatus status,
			WebRequest request) {
		return buildResponseEntity(new ApiResp(false, HttpStatus.ACCEPTED.ordinal(), ex.getMessage(), "", null));
	}

	private ResponseEntity<Object> buildResponseEntity(ApiResp apiResp) {
